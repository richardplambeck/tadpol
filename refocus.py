...
def signal_handler(signal, frame):
  ...
  print "Waiting for 4 seconds, then resetting focus values to their NOMINAL positions."
  print "See the refocus.py script in the 'scripts' area for the nominal focus positions."
  time.sleep(4)
  restoreFocus()
  #antList = SAC.currentAntennaNumbers()
  #print len(startFocus),len(antList)
  #print startFocus, antList
  #for idx in range(0,len(antList)) :
  #  SAC.focus( None, None, startFocus[idx], antList[idx] )
  #time.sleep(4)
  #if focusMoving( antList) :
  #  print "hey - timed out and a focus is still changing! Please call this function again."  
  sys.exit(0)
